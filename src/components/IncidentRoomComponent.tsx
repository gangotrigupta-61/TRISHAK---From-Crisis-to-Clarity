...
export default function IncidentRoomComponent({ incidentId, onBack, fullScreenLink = true }: IncidentRoomComponentProps) {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 h-full lg:max-h-[85vh] lg:overflow-hidden pb-12 lg:pb-0 transition-colors duration-500">
              ...
              {isEditing ? (
                <div className="space-y-3">
                  <textarea 
                    ...
                    className="w-full bg-bg-primary border border-card-border rounded-2xl p-4 text-xs font-bold min-h-[100px] outline-none focus:border-accent-emergency transition-all text-text-primary"
                  />
      ...
      <div className="flex-1 flex flex-col bg-bg-primary rounded-[1.5rem] lg:rounded-[2.5rem] border border-card-border shadow-xl overflow-hidden min-h-[450px] lg:min-h-[400px] transition-colors duration-300">
        {/* Chat Header */}
          ...
          <div className="flex items-center gap-3 lg:gap-4">
            ...
            <div className="min-w-0">
              ...
              <div className="flex items-center gap-1.5 lg:gap-2">
                ...
                <p className="text-[8px] lg:text-[10px] text-text-secondary font-bold uppercase tracking-[0.1em] lg:tracking-[0.2em] truncate">Live Sync Active</p>
              </div>
            </div>
          </div>
          <div className="flex items-center gap-3">
        ...
        <div 
          ref={scrollRef}
          className="flex-1 overflow-y-auto p-4 lg:p-8 space-y-2 custom-scrollbar transition-colors duration-300 bg-bg-primary/50 min-h-[300px]"
        >
              ...
              return (
                <div key={msg.id} className="flex items-start gap-4 py-2 group">
                  <div className="flex flex-col items-center gap-1 shrink-0 mt-1">
                    ...
                    <div className="w-0.5 grow bg-card-border min-h-[10px] opacity-30" />
                  </div>
                  <div className="flex-1 min-w-0">
      ...
      <AnimatePresence>
              ...
              <div className="grid grid-cols-2 gap-4 lg:gap-6">
                {SOS_TYPES.map((type) => (
                  <button 
                    ...
                    className="flex flex-col items-center justify-center gap-3 lg:gap-5 p-4 lg:p-8 rounded-[1.5rem] lg:rounded-[2rem] bg-bg-primary border border-card-border hover:shadow-xl hover:border-text-secondary transition-all group"
                  >
                    <div className={cn(
                    ...
                    <span className="text-[10px] lg:text-xs font-black uppercase tracking-[0.1em] text-text-primary">{type.label}</span>
                  </button>
                ))}
              </div>
        ...
        {showEtaModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="bg-bg-secondary rounded-[2rem] p-6 w-full max-w-sm border border-card-border">
